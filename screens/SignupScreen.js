...
export default function SignupScreen({ navigation }) {
    ...
    function inputAction(name, value){
        switch(name){
            case 'firstName':
                setfirstName(value);
                break;
    ...
    function inputActionErr(name, errorMessage = ""){
        switch(name){
            case 'firstName':
            ...
            case 'email':
                ...
                break;
            case 'phoneNumber':
                setphoneNumberErr(errorMessage);
                break;
            case 'pwd':
                setpwdErr(errorMessage);
                break;
            case 'pwdConfirmation':
                setpwdConfirmationErr(errorMessage);
                break;
        }
    }

    function handleChange(name, value){
        inputAction(name, value);
        inputActionErr(name, "");
    }
    ...
    function handleSubmit(){
        ...
        for(const [ key, value ] of form){
            if(!requiredInput(key, value)){
                inputActionErr(key,"Required field");
                goodToGo = false;
            } else {
                inputActionErr(key,"");
                if( key === "pwd" ){
